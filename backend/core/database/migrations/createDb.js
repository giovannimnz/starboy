    ...
    try {
        ...
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS corretoras (
                ...
                ativa BOOLEAN DEFAULT 1 COMMENT 'Se esta configuração está ativa',
        ...
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS ordens (
                ...
                is_maker_side BOOLEAN DEFAULT NULL COMMENT 'Is this trade the maker side (o.m)',
                ...
                price_protection BOOLEAN DEFAULT NULL COMMENT 'Price protection (o.pP)',
        ...
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS webhook_signals (
                ...
                divap_confirmado BOOLEAN DEFAULT NULL,
                cancelado_checker BOOLEAN DEFAULT NULL,
                sent_msg BOOLEAN DEFAULT 0,
        ...
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS signals_analysis (
                ...
                is_bear_divap BOOLEAN DEFAULT 0,
                divap_confirmed BOOLEAN DEFAULT 0,
                rsi FLOAT DEFAULT NULL,
                volume DOUBLE DEFAULT NULL,
                volume_sma DOUBLE DEFAULT NULL,
                high_volume BOOLEAN DEFAULT 0,
                bull_div BOOLEAN DEFAULT 0,
                bear_div BOOLEAN DEFAULT 0,
                message TEXT DEFAULT NULL,
                price_reversal_up BOOLEAN DEFAULT 0,
                price_reversal_down BOOLEAN DEFAULT 0,
        ...
        await connection.execute(`
            CREATE TABLE IF NOT EXISTS signals_msg (
                ...
                is_reply BOOLEAN NOT NULL DEFAULT 0 COMMENT 'Se é uma resposta a outra mensagem',
