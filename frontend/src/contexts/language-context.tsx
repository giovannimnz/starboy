...
const translations = {
  ...
  en: {
    ...
    "risk.recommendation": "Recommended: 1-5% for conservative, 5-10% for aggressive",
  ...
  es: {
    ...
    "select.max.positions": "Seleccione el máximo de posiciones",
    position: "Posición",
    positions: "Posiciones",
    "maximum.positions.help": "Número máximo de posiciones abertas al mesmo tempo",
    "start.bot": "Iniciar Bot",
    "stop.bot": "Parar Bot",
    "current.configuration": "Configuración atual e performance",
    strategy: "Estratégia",
